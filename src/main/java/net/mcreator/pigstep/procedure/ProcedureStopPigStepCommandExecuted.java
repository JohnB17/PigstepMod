...
public class ProcedureStopPigStepCommandExecuted extends ElementsPigstepMod.ModElement {
	public ProcedureStopPigStepCommandExecuted(ElementsPigstepMod instance) {
		super(instance, 4);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure StopPigStepCommandExecuted!");
			return;
		}
